...
def test(model, test_loader, criterion, device, epoch_no):
    ...
    running_loss = 0
    running_corrects = 0
    with torch.no_grad(): #We do not want to calculate gradients while testing
...
def create_data_loaders(data, batch_size):
    ...
    test_dataset_path = os.path.join(data, "valid")
...
def main(args):
    ...
    #Using AdamW as it yields usually better performance then Adam in most cases due to the way it uses weight decay in computations
...
if __name__=='__main__':
    ...
    '''
    Adding all the hyperparameter needed to use to train your model.
    '''
